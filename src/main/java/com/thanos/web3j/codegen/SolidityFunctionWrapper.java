package com.thanos.web3j.codegen;
...
import com.thanos.web3j.abi.datatypes.generated.AbiTypes;
import com.thanos.web3j.crypto.Credentials;
import com.thanos.web3j.crypto.EncryptType;
import com.thanos.web3j.protocol.ObjectMapperFactory;
...
import com.thanos.web3j.protocol.core.methods.response.AbiDefinition;
...
import com.thanos.web3j.utils.Collection;
...
public class SolidityFunctionWrapper {
    ...
    static java.lang.reflect.Type SET_CLASS = Set.class;
    static MethodSpec buildFunction(
        ...
        methodBuilder.addParameter(SET_CLASS, "executeStates");
        return methodBuilder.build();
    }
    ...
    private static void buildTransactionFunction(
        ...
        methodBuilder.returns(ParameterizedTypeName.get(Future.class, ThanosTransactionReceipt.class));
        ...
        methodBuilder.addStatement("$T function = new $T($S, $T.<$T>asList($L), $T"
                ...
                TypeReference.class);
        if (functionDefinition.isPayable()) {
            methodBuilder.addStatement("return executeTransactionAsync(function, executeStates, $N)", WEI_VALUE);
        } else {
            methodBuilder.addStatement("return executeTransactionAsync(function, executeStates)");
        }
    }
    ...
    static MethodSpec buildEventTransactionReceiptFunction(String responseClassName, String
        ...
        MethodSpec.Builder transactionMethodBuilder = MethodSpec
                ...
                .addParameter(ThanosTransactionReceipt.class, "transactionReceipt")
                .returns(parameterizedTypeName);

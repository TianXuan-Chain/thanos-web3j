...
import com.thanos.web3j.model.state.ValidatorPublicKeyInfo;
...
public class NodeCandidate extends RLPModel {
    ...
    public NodeCandidate(byte[] id, String name, String agency, String caHash, long consensusVotingPower, int shardingNum, int processType) {
        super(null);
    ...
    public static NodeCandidate convertFrom(VoteNodeCandidateEvent voteNodeCandidateEvent) {
        NodeCandidate nodeCandidate = new NodeCandidate(ByteUtil.copyFrom(voteNodeCandidateEvent.getId()), new String(voteNodeCandidateEvent.getName().getBytes()), new String(voteNodeCandidateEvent.getAgency().getBytes()), new String(voteNodeCandidateEvent.getCaHash().getBytes()), voteNodeCandidateEvent.getConsensusVotingPower(), voteNodeCandidateEvent.getShardingNum(), voteNodeCandidateEvent.getProcessType());

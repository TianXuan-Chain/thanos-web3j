...
public class CommitteeCandidate extends RLPModel {
    ...
    public static CommitteeCandidate convertFrom(VoteCommitteeCandidateEvent candidateEvent) {
        CommitteeCandidate committeeCandidate = new CommitteeCandidate(candidateEvent.getProcessType(), ByteUtil.copyFrom(candidateEvent.getProposalId()), new ByteArrayWrapper(ByteUtil.copyFrom(candidateEvent.getVoteCommitteeAddr())));
        return committeeCandidate;
    }
}

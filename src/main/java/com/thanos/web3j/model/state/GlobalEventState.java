...
import com.thanos.web3j.model.event.snapshot.CandidateStateSnapshot;
import com.thanos.web3j.model.event.snapshot.FilterCandidate;
...
public class GlobalEventState extends RLPModel {
    ...
    List<ThanosGlobalNodeEventReceipt> globalNodeEventReceipts;
    ...
    public void removeBlackNode(ValidatorPublicKeyInfo node) {
        this.nodeBlackList.remove(node);
    }
    ...
    public void addOperationsStaff(ByteArrayWrapper opStaffAddr) {
        boolean exist = false;
        if (operationsStaffAddrSet.equals(opStaffAddr)) {
            exist = true;
        }
    ...
    public List<ThanosGlobalNodeEventReceipt> getGlobalNodeEventReceipts() {
    ...
    public void addGlobalNodeEventReceipts(ThanosGlobalNodeEventReceipt globalNodeEventReceipt) {
...
//        this.globalEventProcessState = globalEventProcessState;
    ...
    public void calculateStateRoot() {
        ...
        try {
            ...
            for (ThanosGlobalNodeEventReceipt receipt: globalNodeEventReceipts) {

package com.thanos.web3j.protocol.rx;
...
import com.thanos.web3j.protocol.core.DefaultBlockParameterNumber;
import com.thanos.web3j.protocol.core.filters.BlockFilter;
import com.thanos.web3j.protocol.core.filters.LogFilter;
import com.thanos.web3j.protocol.core.filters.PendingTransactionFilter;
...
import com.thanos.web3j.protocol.core.methods.response.Transaction;
import com.thanos.web3j.utils.Observables;
...
public class JsonRpc2_0Rx {
    ...
    public Observable<Log> ethLogObservable(
            com.thanos.web3j.protocol.core.methods.request.EthFilter ethFilter, long pollingInterval) {
    ...
    private <T> void run(
            com.thanos.web3j.protocol.core.filters.Filter<T> filter, Subscriber<? super T> subscriber,
